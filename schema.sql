...
DROP TABLE IF EXISTS `Product Characteristic`;

CREATE TABLE `Product Characteristic` (
...
DROP TABLE IF EXISTS `Characteristic Review`;

CREATE TABLE `Characteristic Review` (
  `id_Characteristic Review` serial PRIMARY KEY,
  `id_Review` INT NOT NULL,
  `id_Characteristics` INT NOT NULL,
  FOREIGN KEY ("id_Review")
  REFERENCES "Review" ("id_Review"),
